...
public class WalkState : StateMachineBehaviour
{
    ...
    override public void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        // ----- get all waypoints and move to the first ------ //
        GameObject waypointsCluster = animator.GetComponent<NPCWaypoints>().waypointsCluster;
        foreach (Transform tracked in waypointsCluster.transform)
        {
            waypointsList.Add(tracked);
        }
